  ...
  statusUpdateHandler = event => {
    ...
    fetch("http://localhost:8080/graphql", {
      ...
      .then(resData => {
        ...
        console.log(resData.data.updateStatus);
      })
      .catch(this.catchError);
  };
  ...
  finishEditHandler = postData => {
    ...
    fetch("http://localhost:8080/post-image", {
      ...
      .then(fileResponse => {
        ...
        if (this.state.editPost) {
          graphqlQuery = {
            query: `mutation updatePost($postId: ID!, $title: String!, $content: String!, $imageUrl: String!) {
      ...
      .then(resData => {
        ...
        if (resData.errors) {
          throw new Error("Created post failed!");
        }
        console.log(resData);
  ...
  deletePostHandler = postId => {
    ...
    fetch("http://localhost:8080/graphql", {
      ...
      .then(resData => {
        ...
        if (resData.errors) {
          throw new Error("Deleted post failed!");
        }
        console.log(resData);
        this.loadPosts();
        // this.setState(prevState => {
